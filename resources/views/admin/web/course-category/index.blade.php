                    ...
                    <form class="needs-validation" action="{{ route('admin.category.store') }}" method="post">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Add New Course Category</h5>
                            </div>
                            <div class="card-block pdng">
                                <!-- Form Start -->
                                <div class="form-group">
                                    <label for="title" class="form-label">Course Category<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control" placeholder="Enter Course Category">
                                    @error('name')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-danger btn-sm"
                                                        onclick="confirmDelete('{{ route('admin.category.delete', $data->id) }}')">Delete</a>
                                                </td>
                                            </tr>
