                    ...
                    <div class="card">
                        <div class="card-header header-elements-inline">
                            ...
                            <div class="header-elements ms-3">
                                ...
                                <select class="form-control" id="certificate_status">
                                    <option value="">All</option>
                        ...
                        <div class="card-block pdng">
                            ...
                            <div class="table-responsive">
                                <table id="payment_table"
                                    class="display table table-bordered nowrap table-striped table-hover"
                                    style="width:100%">
    ...
    <script>
        $(document).ready(function() {
            const table = $('#payment_table').DataTable({
                ...
                dom: 'frtip',
                ajax: {
                    url: "{{ route('admin.oldGetCertificatesData') }}",
                    type: 'POST',
                    data: function(d) {
                ...
                columns: [{
                    ...
                    {
                        data: 'urgent_mode_status',
                        name: 'urgent_mode_status',
                        orderable: false,
                        searchable: false
                    },
                    {
                        data: 'certificate_status_text',
            ...
            function exportWith(format) {
                ...
                window.location.href = "{{ route('admin.exportOldCertificates', ['format' => 'csv']) }}".replace('csv', format) + '?' + params.toString();
            }
            ...
            $('#export_copy').on('click', async function() {
                const url = "{{ route('admin.exportOldCertificates', ['format' => 'csv']) }}" + '?' + new URLSearchParams({
                    from_date: $('#from_date').val() || '',
                    to_date: $('#to_date').val() || '',
                    payment_type: $('#payment_type').val() || '',
                    urgent_mode: $('#urgent_mode').val() || '',
