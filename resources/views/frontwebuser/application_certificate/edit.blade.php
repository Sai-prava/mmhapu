            ...
            <form action="{{ route('frontwebuser.certificateUpdate') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="urgent_mode" value="0"
                                {{ $certificate->urgent_mode == 0 ? 'checked' : '' }}>
                            <label class="form-check-label" for="pending">Pending</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="urgent_mode" value="1"
