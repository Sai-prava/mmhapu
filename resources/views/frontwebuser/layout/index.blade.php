                ...
                <div class="card card-sidebar-mobile">
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item-header">
                            <div class="text-uppercase font-size-xs line-height-xs">Front Web User Panel</div> <i
                                class="icon-menu" title="Main"></i>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('frontwebuser.dashboard.index') }}"
                                class="nav-link {{ Request::is('frontwebuser/dashboard') ? 'active' : '' }}">
            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-md-inline">
                    <div class="page-title d-flex">
                        <h4><a href="{{ route('frontwebuser.dashboard.index') }}"><i
