...
@section('content')
    <div class="main-body">
        <div class="page-wrapper">
            <div class="row">
                <div class="col-md-5">
                    <form class="needs-validation" action="{{ route('admin.elearningTitle.store') }}" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <h5>Add New e-Learning Title</h5>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-danger btn-sm"
                                                        onclick="confirmDelete('{{ route('admin.elearningTitle.delete', $data->id) }}')">Delete</a>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="needs-validation" novalidate
                                                            action="{{ route('admin.elearningTitle.update', $data->id) }}"
                                                            method="POST">
                                                            @csrf
