...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Add KRC Without AICTE Recognition</h5>
        </div>
        <div class="col-lg-12">
            <form action="{{ route('admin.krcWithoutAicte.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
