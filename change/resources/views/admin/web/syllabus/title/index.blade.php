...
@section('content')
    <div class="main-body">
        <div class="page-wrapper">
            <div class="row">
                <div class="col-md-5">
                    <form class="needs-validation" action="{{ route('admin.syllabus.insert') }}" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <h5>Add New Syllabus Title</h5>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-danger btn-sm"
                                                        onclick="confirmDelete('{{ route('admin.syllabus.destory', $data->id) }}')">Delete</a>
                                                </td>
                                            </tr>
                                            ...
                                            <div class="modal fade" id="editModal{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="needs-validation" novalidate action="{{ route('admin.syllabus.updateTitle', $data->id) }}"
                                                            method="POST">
                                                            @csrf
