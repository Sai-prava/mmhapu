...
@section('title')
    University Administration Title
@endsection
...
@section('content')
    <div class="main-body">
        <div class="page-wrapper">
            <div class="row">
                <div class="col-md-5">
                    <form class="needs-validation" action="{{ route('admin.university_officers_title.store') }}"
                        method="post">
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <h5>Add New University Administration Title</h5>
                            </div>
                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-header">
                            <h5>Manage University Administration Title</h5>
                        </div>
                        <div class="card-block pdng">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-danger btn-sm"
                                                        onclick="confirmDelete('{{ route('admin.university_officers_title.delete', $data->id) }}')">Delete</a>
                                                </td>
                                            </tr>
                                            ...
                                            <div class="modal fade" id="editModal{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="needs-validation" novalidate action="{{ route('admin.university_officers_title.update', $data->id) }}"
                                                            method="POST">
                                                            @csrf
