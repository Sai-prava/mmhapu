...
@section('content')
    <div class="card">
        ...
        <div class="col-lg-12">
            <form action="{{ route('admin.evaluation_report.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <div class="col-lg-6 mb-3">
                        <label for="notice_type" class="form-label">File<span style="color: red">*</span></label>
                        <br>
                        <a class="text-warning" href="{{ asset('uploads/evaluation/' . $edit->file) }}" target="_blank">{{$edit->file}}</a>
                    </div>
                </div>
                <div class="mb-3">
